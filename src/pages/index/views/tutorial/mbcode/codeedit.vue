<template>
  <el-card>
    ...
    <el-row>
      <el-input v-model="mbDes" placeholder="请输入模板描述" style="width:300px;"/>
    </el-row>
    <el-row>
      <el-autocomplete
      ...
      />
      <el-button type="primary" style="margin-left:30px;" @click="getcode">获取代码</el-button>
    </el-row>
    <el-row>
      <el-input v-model="des" type="textarea" placeholder="请输入代码介绍，支持MD格式，在导出时有效" style="width:300px;"/>
    </el-row>
    <el-row>
    ...
    created () {
        ...
        this.$axios
            ...
            .then(response => {
                ...
                this.no = !(response.data.length > 0)
            })
            .catch(error => {
                this.$message.error(
